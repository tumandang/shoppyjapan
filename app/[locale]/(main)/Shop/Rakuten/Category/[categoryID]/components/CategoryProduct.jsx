  ...
  useEffect(() => {
    ...
    if (foundCategory) {
      if (locale === 'en') {
        ...
        setSelectedCategory(foundCategory.jp)
      }
      else{
        setSelectedCategory(foundCategory.ms)
      }
      ...
      <div className="flex gap-6 mt-6">
        ...
        <section className="flex-1">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link
              href={`/${locale}/Shop/Rakuten/Category/CategoryProduct/${categoryID}`}
