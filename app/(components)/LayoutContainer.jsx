import { Coins, QrCode, ShieldEllipsis, ShoppingBag, Smartphone, Trophy } from 'lucide-react'
            ...
            <div className="  flex flex-row gap-x-4">
                ...
                <div className="flex flex-col gap-y-2 w-1/4">
                    <div className="relative bg-white rounded-lg shadow-lg  p-2">
                        ...
                        />
                         <Button variant="outline" className="absolute  bottom-4 left-1/2 -translate-x-1/2 bg-white hover:bg-gray-100 text-black font-semibold shadow-lg transition-colors duration-200">Calculate Shipping</Button>
                    ...
                    <div className="bg-white rounded-lg shadow-lg  flexCenter flex-col p-2 gap-y-5">
                        ...
                        <Button variant="outline" className="  border border-gray-400 px-2 py-1 shadow-md rounded-lg ">Android</Button>
                    </div>
                </div>
